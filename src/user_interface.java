        ...
        while(true){
            ...
            switch (pilihan){
                ...
                case "U":
                    ...
                    if (index >= 0){
                        System.out.println("Anda akam meng-update data "+db.getData().get(index));
                        System.out.println("INPUT DATA BARU");
                        System.out.print("NIM            : ");
                        nim = sc.nextLine();
                ...
                case "D":
                    ...
                    db.view();
                    System.out.print("Input Key (NIM Mahasiswa yang akan di dihapus): ");
                    key = sc.nextLine();
                    index = db.search(key);
                    if (index>= 0){
                        System.out.println("Anda akam meng-hapus data "+db.getData().get(index));
                        System.out.print("pilih : ");
                        pilihan = sc.nextLine();
                        if (pilihan.equalsIgnoreCase("Y")){
                            status = db.delete(index);
                            if (status == true){
                                System.out.println("DATA BARU BERHASIL DIHAPUS");
                            }else{
